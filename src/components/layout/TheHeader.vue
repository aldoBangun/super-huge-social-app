<template>
   <header class="bg-white mb-8 shadow-sm">
      <nav class="vw-80 mx-auto h-16 flex-center justify-between">
         ...
         <div class="text-lg">
            <ul
               class="nav-page flex-center gap-4 text-gray-400"
            ...
            <ul class="nav-user flex-center gap-4" v-else>
               <li>
                  <router-link
               ...
               <li>
                  <router-link
                     class="flex-center text-white bg-blue-500 hover:bg-blue-700 h-8 px-4 rounded-full"
                     to="/register"
                     >Sign Up</router-link
                  >
               </li>
